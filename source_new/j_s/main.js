...
function calZodiac() {
  ...
  var outputImg=document.getElementById("allPics");
...
function displaySound(whichSound) {
  console.log("sound was called" + astroSign);

  if (astroSign === 'Azorious Senate!'){
    document.getElementById('azor').play(); 
  }
  else if (astroSign === 'Cult Of Rakdos!'){
    document.getElementById('rakd').play(); 
  }
  else if (astroSign === 'House Dimir!'){
    document.getElementById('dimir').play(); 
  }
  else if (astroSign === 'Selesnya Conclave!'){
    document.getElementById('seles').play(); 
  }
  else if (astroSign === 'Orzhov Syndicate!'){
    document.getElementById('orhz').play(); 
  }
  else if (astroSign === 'Golgari Swarm!'){
    document.getElementById('golg').play(); 
  }
  else if (astroSign === 'Simic Combine!'){
    document.getElementById('simic').play(); 
  }
  else if (astroSign === 'Gruul clans!'){
    document.getElementById('gruu').play(); 
  }
  else if (astroSign === 'Boros Legion!'){
    document.getElementById('boros').play(); 
  }
  else if (astroSign === 'Izzet League!'){
    document.getElementById('izzet').play(); 
  }
  else if (astroSign === 'Transguild!'){
    document.getElementById('trans').play(); 
  }
  else if (astroSign === 'Bystander!'){
    document.getElementById('byst').play(); 
  }
